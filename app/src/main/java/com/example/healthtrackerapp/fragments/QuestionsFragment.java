...
import com.example.healthtrackerapp.classes.QuestionsAdapter;
...
public class QuestionsFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        stringArrayList.add("Sleep Question");
        stringArrayList.add("Nutrition Question");
        stringArrayList.add("Stress Question");
        stringArrayList.add("Alcohol Question");
        recyclerView = view.findViewById(R.id.questionsRecyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter = new QuestionsAdapter(stringArrayList, getContext());
